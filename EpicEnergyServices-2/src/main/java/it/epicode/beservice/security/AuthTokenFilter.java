...
/*
 * il codice HTML viene analizzato e renderizzatoi dal browser
 * il codice XML viene anche esso analizzato, ma dal parser dato che non deve essere renderizzato 
 */
